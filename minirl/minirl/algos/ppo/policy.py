...
class PPOBasePolicy(ParamsMixin, nn.Module):
    def __init__(
        ...
        film: bool = False,
        coef_traj: float = 1.0,
        sparse_rew: bool = False,
        coef_sparse_rew: float = 1.0,
        icm_rew: bool = False,
        coef_icm_rew: float = 1.0,
        lap2: float = 1.0,
        coef_lap2: float = 1.0,
        mec: bool = False,
        coef_mec: float = 1.0,
        std: bool = False,
        lra_p: bool = False,
        coef_lra_p: float = 1.0,
        contrast_future: bool = False,
        coef_cont_future: float = 1.0,
        critical: bool = False,
        coef_critical: float = 1.0,
        pred_rew: bool = False,
        coef_pred_rew: float = 1.0,
        bt: bool = False,
        coef_bt: float = 1.0,
    ):
        ...
        self.film = film
        self.coef_traj = coef_traj
        self.sparse_rew = sparse_rew
        self.coef_sparse_rew = coef_sparse_rew
        self.icm_rew = icm_rew
        self.coef_icm_rew = coef_icm_rew
        self.lap2 = lap2
        self.coef_lap2 = coef_lap2
        self.mec = mec
        self.coef_mec = coef_mec
        self.std = std
        self.lra_p = lra_p
        self.coef_lra_p = coef_lra_p
        self.contrast_future = contrast_future
        self.coef_cont_future = coef_cont_future
        self.critical = critical
        self.coef_critical = coef_critical
        self.pred_rew = pred_rew
        self.coef_pred_rew = coef_pred_rew
        self.bt = bt
        self.coef_bt = coef_bt
